...
{#if drawerOpen}
	...
	<!-- Sheet -->
	<div
		class="fixed right-0 bottom-0 left-0 z-50 rounded-t-2xl bg-white shadow-xl"
	...
	>
		...
		<div class="px-4 pb-4" style="padding-bottom: calc(1rem + var(--safe-bottom))">
			<div class="mb-3 flex items-center justify-between">
				<span class="text-sm font-semibold text-slate-500 uppercase tracking-wide">More</span>
